...
// const TOKEN =
// 	''
...
// 		method: 'POST',
// 		headers,
// 		body: JSON.stringify({ data: { name: cat.name, bg: cat.bg } }),
// 	})
// 	const data = await res.json()
// 	if (!res.ok) {
// 		console.warn(
// 			`  ⚠ Category create failed: ${cat.name} — ${JSON.stringify(data)}`
// 		)
// 		return null
// 	}
...
// 			bg: product.bg,
// 			// ВАЖНО: попробуйте передать как массив [categoryId]
// 			category: categoryId ? [categoryId] : [],
// 			// Изображение передается как ID (одиночное)
// 			image: imageId || null,
// 		},
// 	}
...
// 		console.warn(`  ⚠ Product create failed: ${product.title}`)
...
// 		} else {
// 			console.warn(`  ⚠ Failed to create category: ${cat.name}`)
// 		}
// 	}
...
const TOKEN =
	''.trim()
