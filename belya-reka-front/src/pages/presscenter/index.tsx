...
const PressCenter: FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("press_center.seo_title")}</title>
      </Helmet>
      <main>
        <BannerCommon
          banner={banner}
          bannerTitle={t("press_center.banner_title")}
          bannerDescription={<p className="text-white text-2xl text-balance">{t("press_center.banner_description")}</p>}
        />
