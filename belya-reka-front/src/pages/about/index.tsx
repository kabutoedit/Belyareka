  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content={t("about_page.seo_description")} />
        <meta property="og:title" content="Белая река" />
        <meta property="og:url" content="https://belyareka.kg/" />
        <meta property="og:image" content={`${CDN_BASE}/assets/media/picture/banner04.webp`} />
      </Helmet>

      <main className="overflow-hidden">
        <BannerCommon
          banner={banner}
          bannerTitle={t("about_page.banner_title")}
          bannerDescription={<p className="text-white text-2xl text-balance max-w-[800px]">{t("about_page.banner_description")}</p>}
        />
