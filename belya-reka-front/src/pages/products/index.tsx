...
const Products: FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("products_page.seo_title")}</title>
      </Helmet>

      <main>
        <BannerCommon
          banner={banner}
          bannerTitle={t("products_page.banner_title")}
          bannerDescription={<p className="text-white text-2xl">{t("products_page.banner_description")}</p>}
        />
