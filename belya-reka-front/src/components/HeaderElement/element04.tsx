      ...
      {activeSlide && (
        <motion.div
          ...
          <div className="absolute w-full bottom-0 left-0 -z-10 h-0">
            <div className="absolute bottom-0 left-10 sm:left-80 md:left-96 lg:left-[300px] xl:left-[160px] w-[800px]">
              <img
                className="absolute bottom-0 left-0 h-[300px] sm:h-[340px] lg:h-96 xl:h-[480px] 2xl:h-[550px]"
                {...imageProps}
          ...
          <div className="relative z-40">
            <img className="absolute w-[82px] -right-10 top-[710px] md:-right-10 md:w-[100px] 2xl:w-40 2xl:top-[610px]" src={freshmint} alt="image" />
            <img
              className="absolute w-[82px] right-16 top-[300px] 2xl:w-24 2xl:top-[400px]"
              src={juniperberrieslevitatewhitebackground}
              alt="image"
            />
            <img className="absolute w-[103px] right-14 top-5 2xl:w-40" src={leaf940} alt="image" />
            <img className="absolute w-[82px] left-2 top-36 2xl:w-24 2xl:top-20" src={leaf0023} alt="image" />
            <img className="absolute w-40 top-[650px] -left-20 2xl:w-60 2xl:top-[600px] 2xl:-left-32" src={strawberry} alt="image" />
          </div>
