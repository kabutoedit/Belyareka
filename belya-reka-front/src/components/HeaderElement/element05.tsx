      ...
      {activeSlide && (
        <motion.div
          ...
          <div className="absolute w-full bottom-0 left-0 -z-10 h-0">
            <div className="absolute bottom-0 -left-10 sm:left-16 w-[800px]">
              <img className="absolute bottom-0 h-[250px] md:h-[300px] lg:h-[350px] 2xl:h-96" {...imageProps} src={yogurt_common} />
              {!isMobile && (
                <img
                  className="absolute bottom-0 -left-20 h-48 md:left-[500px] md:h-56 lg:h-64 lg:left-[580px] 2xl:h-80 2xl:left-[650px]"
          ...
          <div className="relative z-40">
            ...
            <img
              ...
              alt="image"
            />
            <img className="absolute w-[109px] left-5 top-7 sm:left-24 md:w-32 lg:w-48 lg:top-20 2xl:w-60" src={afdasf} alt="image" />
          </div>
          ...
          {/* <div className="absolute text-white right-[10%] top-[15%] w-80 z-40 sm:w-96 sm:right-36 sm:top-[10%] md:w-[470px] md:top-[10%] md:right-[20%] lg:w-[600px] lg:right-0 lg:top-[20%] xl:right-0 xl:top-[30%] 2xl:right-0 2xl:top-[30%]">
            ...
            <p className="font-normal text-xl text-center sm:text-2xl mt-3 md:text-3xl md:mt-2 lg:text-left lg:text-2xl lg:w-[500px] xl:text-left xl:text-3xl leading-7 ">
              Самый простой способ совместить приятное с полезным – выбор йогурта каждый день. Мы создали несколько вкусов: больше удовольствия – больше пользы!
            </p>
          </div> */}
        </motion.div>
      )}
