...
const AchievBlockSection: FC = () => {
  ...
  const achievInfo = [
    { lottieAnim: peoplesLottie, nums: 468, descr: t("achiev.peoples"), suffix: undefined, char: 95 },
    { lottieAnim: geoLottie, nums: 10_000, descr: t("achiev.regions"), suffix: undefined, char: 90 },
    { lottieAnim: cowLottie, nums: 15_000, descr: t("achiev.cows"), suffix: undefined, char: 80 },
    { lottieAnim: tractorLottie, nums: 200, descr: t("achiev.equipment"), suffix: undefined, char: 87 },
    { lottieAnim: lugLottie, nums: 8_000, descr: t("achiev.land"), suffix: undefined, char: 79 },
    { lottieAnim: teleshkiLottie, nums: 8_000, descr: t("achiev.shops"), suffix: undefined, char: 85 },
    { lottieAnim: milkLottie, nums: 150, descr: t("achiev.milk"), suffix: t("achiev.milkSuffix"), char: 97 },
  ];
  return (
    <ContainerLayout>
      <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 grid-cols-1 gap-10">
