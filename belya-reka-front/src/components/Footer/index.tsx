...
const Footer: FC = () => {
  ...
  const contacts = [
    { title: t("footer.sales_bishkek"), link: "n.mambetov@belayareka.kg" },
    { title: t("footer.sales_osh"), link: "n.mamyrov@belayareka.kg" },
    { title: t("footer.sales_jalal"), link: "m.kushbakov@belayareka.kg" },
    { title: t("footer.export"), link: "a.asanbekov@belayareka.kg" },
    { title: t("footer.hr"), link: "r.rysbaeva@belayareka.kg" },
  ];
  return (
    <footer className="footer bg-hexahrome mt-24">
      <ContainerLayout className="py-24">
        <div className="relative z-20 md:mb-36 mb-0">
          <h1 className="text-white text-4xl font-medium">{t("footer.title")}</h1>
          <div className="flex md:flex-nowrap flex-wrap mb-8 text-white gap-5">
            <div className="footer__map md:w-3/4 w-full">
              <LazyLoadLayout>
                <MapYandex />
            ...
            <div className="md:w-1/4 w-full flex flex-col flex-shrink-0">
              <div className="flex flex-col gap-y-4">
                <h5 className="text-2xl font-bold">{t("footer.hotline")}</h5>
                <a href="tel:+996553333000" className="text-white no-underline text-lg font-semibold flex gap-2">
                  <img loading="lazy" src={telephoneSVG} alt="phone" />
                  +996 &#40;553&#41; 333 000
                </a>
                ...
                <span className="font-normal text-lg">{t("footer.workHours")}</span>
              </div>
              <div className="mt-20 flex flex-col gap-y-5">
                {contacts?.map((item, i) => (
                  <div key={i}>
